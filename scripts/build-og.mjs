...
const PAGES = [
  ...
  {
    slug: 'blog-ausbildung-first',
    kicker: 'BLOG · NOTE · APRIL 2026',
    title:  'Ausbildung first.',
    dek:    'Why I did the German vocational route before going to university — and why I am going to university anyway.',
    meta:   '≈ 6 MIN · BLOG',
  },
  {
    slug: 'blog-building-aegis',
    kicker: 'BLOG · SECURITY · APRIL 2026',
    title:  'Six lessons from AEGIS.',
    dek:    'A year of building a deterministic security evaluation harness for tool-using AI agents.',
    meta:   '≈ 8 MIN · BLOG',
  },
  {
    slug: 'blog-public-by-accident',
    kicker: 'BLOG · SECURITY · APRIL 2026',
    title:  'Public, by accident.',
    dek:    'What strangers can pull from your social media. The gap between sharing one thing and revealing another.',
    meta:   '≈ 7 MIN · BLOG',
  },
  {
    slug: 'blog-why-not-notion',
    kicker: 'BLOG · SECURITY · APRIL 2026',
    title:  "Why I didn't use Notion.",
    dek:    'What you give up when you let a hosted platform ship your portfolio for you.',
    meta:   '≈ 5 MIN · BLOG',
  },
  {
    slug: 'blog-tt-season',
    kicker: 'BLOG · FIELD · APRIL 2026',
    title:  'Eighty-seven points.',
    dek:    "From 1670 to 1757. DJK Seifriedsberg's third Landesliga season — and the first finished mid-table.",
    meta:   '≈ 5 MIN · BLOG',
  },
  {
    slug: 'blog-shenzhen',
